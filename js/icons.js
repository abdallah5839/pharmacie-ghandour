/* ============================================
   PHARMACIE GHANDOUR - Icônes SVG
   Basé sur Lucide Icons (https://lucide.dev)
   ============================================ */
...
const ICONS = {
    ...
    // Hygiène - using a different approach
...
// Mapping des anciennes icônes (emojis) vers les nouvelles
const ICON_MAP = {
    // Navigation
    '💊': 'pill',
    '🔍': 'search',
...
/**
 * Obtient l'icône pour une catégorie (SVG brut)
...
/**
 * Remplace un emoji par son icône correspondante
 * @param {string} emoji - L'emoji à remplacer
 * @param {string} [className] - Classes CSS additionnelles
 * @returns {string} HTML de l'icône
 */
